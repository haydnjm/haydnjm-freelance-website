...
import biStackCover from '@/app/case-studies/(posts)/bi-stack/analysis-min.jpg'
import flow from '@/app/case-studies/(posts)/bi-stack/bi-flow.png'
...
<BlogNav 
  previous={{ title: "Technical appraisal", slug: "/case-studies/technical-appraisal" }} 
