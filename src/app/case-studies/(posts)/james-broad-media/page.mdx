...
export const metadata = {
  ...
  description:
    "A media profile website for UK antiques dealer and TV personality James Broad.",
};
...
>### tl;dr
>I created a [media profile website](https://jamesbroad.net) for UK antiques dealer and TV personality James Broad. It scores 100 across the board in Google's Lighthouse
