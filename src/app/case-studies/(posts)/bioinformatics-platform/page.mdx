...
## problem
Soilytix is a bioinformatics company providing a platform for analysing soil data. Their product delivers critical insights into soil health, making it valuable to both academic institutions and agritech companies worldwide.

Although the platform had a strong foundation, Soilytix wanted to overhaul its data structure to support more complex operations and enable advanced features.  

The challenge: implement this update while the product was actively used by customers across regions - from Brazil to the Middle East.
