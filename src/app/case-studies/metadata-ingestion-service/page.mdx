...
export const metadata = {
  ...
  description:
    "A Go microservice to handle metadata ingestion from a fleet of remote devices.",
};
...
## problem
In the [AI on the Edge](/case-studies/ai-on-the-edge) case study, I outline a system where lightweight detection information is transmitted from remote facilities to a cloud-based security system. This data needed to be ingested reliably to enable monitoring and alerting.
...
<ZoomImage src={dashboard} alt="Grafana dashboard" caption="Grafana dashboard showing the health of the metadata ingestion service" />
